...
/**
 * Tests functionality implemented in DisjointSetForest.
...
class DisjointSetForestTest {
	...
	DisjointSetForest<Integer> disjset;
	DisjointSetForest<Integer> empty;
	
	@BeforeEach
	void setUp() throws Exception {
		disjset = new DisjointSetForest<>();
		empty = new DisjointSetForest<>();
